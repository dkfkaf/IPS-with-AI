...
> schema 1·기존 Qt 기능의 기준 문서다. ‘후속 Flow 차단’은 새 연결만을 뜻하지 않는다.
> 판정 적용 이후 해당 IP의 수신 패킷은 기존 연결에서도 차단된다. 통계 timeout은 실제 연결
> 종료와 다를 수 있다. 정확한 의미와 새 관찰 정책은
> [핵심 정책 보완](2026-09-12-core-policy-clarification-design.md)을 따른다.
